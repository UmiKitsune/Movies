...
//    public Movie(int id, int voteCount, String title, String originalTitle, String overview, String posterPath, String bigPosterPath, String backdropPath, double voteAverage) {
//        this.id = id;
//        this.voteCount = voteCount;
//        this.title = title;
//        this.originalTitle = originalTitle;
